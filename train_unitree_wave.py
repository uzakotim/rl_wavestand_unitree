...
from unitree_wave_env import UnitreeWaveEnv


def make_env(rank=0):
    def _init():
        env = UnitreeWaveEnv(
            model_path="/home/timur/git/rl_wavehand_unitree/g1_29dof.xml")
        return env
    return _init
...
if __name__ == "__main__":
    ...
    model = PPO("MlpPolicy", vec_env,
                ...
                learning_rate=3e-4,
                ent_coef=0.01,
                tensorboard_log="./tensorboard/unitree_wave/")

    # Checkpoint
    checkpoint_callback = CheckpointCallback(
        save_freq=50_000, save_path="./models/", name_prefix="ppo_unitree")
    ...
    model.save("./models/ppo_unitree_final")
